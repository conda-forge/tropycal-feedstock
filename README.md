...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tropycal-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13233&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tropycal-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tropycal` can be installed with:

```
conda install tropycal
```

It is possible to list all of the versions of `tropycal` available on your platform with:
